...
// Uses Rectangle2D for named geometry, TrackedShape for face references
...
const panel = panelRect.extrude(tvHeight);
...
// Raise panel to sit on top of stand
const raisedPanel = panel.toShape().translate(0, 0, standH);

return union(stand.toShape(), raisedPanel);
