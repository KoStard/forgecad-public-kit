...
const PHASE_ORDER: Array<'kernel-init' | 'evaluating' | 'serializing'> = ['kernel-init', 'evaluating', 'serializing'];

function EvaluationIndicator({ phase }: { phase: 'idle' | 'kernel-init' | 'evaluating' | 'serializing' }) {
        ...
        {PHASE_ORDER.map((p, i) => (
          <span
            ...
            style={{
              ...
              height: 6,
              borderRadius: '50%',
              background: i <= phaseIdx ? PHASE_CONFIG[p].color : 'var(--fc-border)',
...
export function Viewport() {
  ...
  return (
    ...
    >
      ...
      {isEvaluating && <EvaluationIndicator phase={evaluationPhase} />}
