...
declare function mirrorCopy(shape: ShapeArg, normal: [number, number, number]): Shape;
type ShapeArg$1 = Shape | TrackedShape;
declare function filletEdge(shape: ShapeArg$1, edge: EdgeRef, radius: number, quadrant?: [number, number], segments?: number): Shape;
declare function chamferEdge(shape: ShapeArg$1, edge: EdgeRef, size: number, quadrant?: [number, number]): Shape;
declare function draft(
...
interface RectAreaRef {
  ...
  corners: [Vec3$1, Vec3$1, Vec3$1, Vec3$1];
}
