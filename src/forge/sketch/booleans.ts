...
export function sketchAdd(sketch: Sketch, other: Sketch): Sketch {
  return setSketchBrepProfilePlan(new Sketch(sketch.cross.add(other.cross), sketch.colorHex), null);
}

export function sketchSubtract(sketch: Sketch, other: Sketch): Sketch {
  return setSketchBrepProfilePlan(new Sketch(sketch.cross.subtract(other.cross), sketch.colorHex), null);
}

export function sketchIntersect(sketch: Sketch, other: Sketch): Sketch {
  return setSketchBrepProfilePlan(new Sketch(sketch.cross.intersect(other.cross), sketch.colorHex), null);
}
