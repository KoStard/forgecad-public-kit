...
| 10. Cover mainstream design-feature families across both lowerers | In progress | Shell v1 plus repeated mirror/pattern ownership are in; fillet/chamfer, holes/cuts, projections, and richer patterned descendants still remain. |
