...
const commands: CommandDefinition[] = [
  ...
  },
  {
    group: 'Modeling',
    path: ['run'],
    summary: 'Execute a Forge script with the real runtime and print geometry diagnostics.',
    usage: ['forgecad run <script.forge.js> [--debug-imports]'],
    examples: [
  ...
  },
  {
    group: 'Modeling',
    path: ['notebook'],
    summary: 'Append, execute, and export `.forge-notebook.json` files.',
    usage: [
  ...
  },
  {
    ...
    usage: ['forgecad render <script.forge.js> [output.png] [options]'],
    examples: [
  ...
  },
  {
    group: 'Modeling',
    path: ['capture', 'gif'],
    summary: 'Capture an animated GIF from orbit or jointsView playback.',
    usage: ['forgecad capture gif <script.forge.js> [output.gif] [options]'],
    examples: [
  ...
  },
  {
    group: 'Modeling',
    path: ['capture', 'mp4'],
    summary: 'Capture an MP4 from orbit or jointsView playback.',
    usage: ['forgecad capture mp4 <script.forge.js> [output.mp4] [options]'],
    examples: [
