...
pub struct SolverProfile {
    ...
    pub bottom_up_clusters: u32,
    pub bottom_up_internal_us: u64,
    pub bottom_up_bridge_us: u64,
...
pub fn to_json(p: &SolverProfile) -> String {
    format!(
        ...
        p.gs_escape_rounds,
        p.progressive_steps,
        p.bottom_up_clusters,
        p.bottom_up_internal_us,
        p.bottom_up_bridge_us,
        p.n_vars,
        p.n_rows,
        p.n_constraints,
        p.n_points,
