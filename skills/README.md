...
| [forgecad-optimize-print-time](forgecad-optimize-print-time/SKILL.md) | Optimize a ForgeCAD model for 3D printing time reduction. Use when the user wants to reduce print time for a .forge.js model. Analyzes geometry height, volume, material usage, and compares against reference STLs or known-fast designs. |
