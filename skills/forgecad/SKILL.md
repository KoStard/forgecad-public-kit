...
- `docs/permanent/API/core/reference.md`
...
### 4. Assemblies and Mechanisms (for joints or kinematics)

Assembly graph, joint types, couplings, validation, robot export.

- `docs/permanent/API/assembly/assembly.md`

### 5. Sheet Metal (for bent parts, K-factor, flat patterns)
...
- `docs/permanent/generated/api-reference.md`
